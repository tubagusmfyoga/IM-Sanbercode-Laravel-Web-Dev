...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('tempSEO/src/assets/libs/simplebar/dist/simplebar.min.css') }}"/>
...
@include('partials.nav')
  ...
  <script src="{{ asset('tempSEO/src/assets/libs/simplebar/dist/simplebar.js') }}"></script>
  <script src="{{ asset('tempSEO/src/assets/js/sidebarmenu.js') }}"></script>
  <script src="{{ asset('tempSEO/src/assets/js/app.min.js') }}"></script>
